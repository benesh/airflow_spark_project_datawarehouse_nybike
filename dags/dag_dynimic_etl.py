...
# config={
#     'etl_bronze':{'application_file':'/opt/airflow/jobs/pyspark/etl_bronze_nybike.py', 'config_file':'config_etl_bronze_v2_iceberg.yaml'},
#     'etl_silver':{'application_file':'/opt/airflow/jobs/pyspark/etl_silver_nybike.py','config_file':'config_etl_silver_v2_iceberg.yaml'},
#     'etl_gold':{'application_file':'/opt/airflow/jobs/pyspark/etl_gold_stage.py','config_file':'config_etl_gold_v2_iceberg.yaml'}
# }


# for etl_name,config_jobs in config.items():

#     dag = DAG(
#         dag_id = f"submit_{etl_name}",
#         default_args= {
#             "owner": "Ben omar",
